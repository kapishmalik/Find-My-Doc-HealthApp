<?php
$response = array();
$patientemail="meetika222@gmail.com";
...
$sql="SELECT a.appointmentid,d.name,d.email,c.clinicid,a.appointmentdate,a.appointmenttime, a.appointmentstatuscode,a.purpose,c.address from appointments a join clinicdetails c join doctor d on a.clinicid = c.clinicid and a.docemail = d.email WHERE a.patientemail = '".$patientemail."' and (a.appointmentstatuscode = 0 or a.appointmentstatuscode = 1) and a.appointmentdate > CURDATE()";
